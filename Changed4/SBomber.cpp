    ...
    score(0)
{
    ...
    HouseBuilderA* pHouse1 = new HouseBuilderA;
    pHouse1->SetWidth(13);
    pHouse1->SetPos(70, groundY - 1);
    vecStaticObj.push_back(pHouse1);

    HouseBuilderB* pHouse2 = new HouseBuilderB;
    pHouse2->SetWidth(13);
    pHouse2->SetPos(90, groundY - 1);
    vecStaticObj.push_back(pHouse2);

    /*Director dir;
    HouseBuilder Builder(vecStaticObj, pHouse, pHouse1, pHouse2);
    dir.createHouse(Builder);*/
...
void SBomber::CheckObjects()
{
    ...
    CollisionDetector::CheckPlaneAndLevelGUI();
    CollisionDetector::CheckBombsAndGround();
};

void CollisionDetector::CheckPlaneAndLevelGUI()
{
    if (bomber.FindPlane()->GetX() > bomber.FindLevelGUI()->GetFinishX())
    {
...
{
    vector<Bomb*> vecBombs = bomber.FindAllBombs();
...
{
    vector<DestroyableGroundObject*> vecDestoyableObjects = bomber.FindDestoyableGroundObjects();
